...
:class:`SpectraDownloadPanel` renders one sub-tab per category (Background, Batch records, Live survey); each sub-tab is a :class:`_CategoryDownloadSection` handling that category's file picker, multi-select download, and delete. 
...
<a href="https://github.com/imoralesgt/RIID-gui/blob/main/gui/view_download.py#L28"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
...
<a href="https://github.com/imoralesgt/RIID-gui/blob/main/gui/view_download.py#L38"><img align="right" style="float:right;" src="https://img.shields.io/badge/-source-cccccc?style=flat-square"></a>
